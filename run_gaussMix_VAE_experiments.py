...
from models.GaussMix_VAE import GaussianMix_VAE
...
def build_argparser():
    DESCRIPTION = ("Train a Mixture of Gaussian Variational Autoencoder using Theano.")
...
if __name__ == '__main__':
    ...
    modelType = GaussianMix_VAE

    # P(Z) PARAMS
    prior = [{'mu': -2., 'sigma': 1.}, {'mu': 2., 'sigma': 1.}]
